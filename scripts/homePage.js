...
carouselInner.innerHTML = data
  ...
  <div class="h-100 carousel-item ${index === 0 ? "active" : ""}">
    <div class="row g-0 h-50 imageFit d-flex justify-content-center align-items-center" style="background-image: url(${item.image});">
    <div>
      <div class="center-elements my-2">
        <div class="center-elements gap-3">
          <img class="h-30px" onclick="backward()"
              src="../images/forward-white.png" alt="">
          <img id="playPauseButton" class="h-60px" onclick="playAudio()"
              src="../images/play-white.png" alt="">
          <img class="h-30px" onclick="forward()"
              src="../images/backward-white.png" alt="">
        </div>
        <div class="btn-group dropup ">
          <img class="h-20px" src="../images/audio-menu-white.png" alt=""
      ...
      <div class="center-elements">
        <audio id="myAudio" src="../audios/audio.mp3"></audio>
          <div class="audio-player text-white center-elements">
            <span id="currentTime">0:00</span>
              <input type="range" id="progressBar" value="0" min="0" step="1">
                <span id="totalTime">0:00</span>
          </div>
      </div>
      <div class="wave center-elements" id="wave">
              <span></span>
              <span></span>
              <span></span>
              <span></span>
...
const verticalCarouselInner = document.getElementById("audioVerticalCarouselInner");
...
verticalCarouselInner.innerHTML = data
  ...
  <div class="h-100 carousel-item ${index === 0 ? "active" : ""}" >
    ...
    <div class="col center-elements align-items-end p-5 imageFit"
        style="background-image: url(../images/homepageBgimage2.jpg);">
        <div class="row g-0">
            <div class="center-elements my-3">
                <div class="col-10 gap-3 center-elements px-5">
                    <img class="h-30px" onclick="backward()" src="../images/forward-white.png" alt="">
                    <img id="playPauseButton" class="h-60px" onclick="playAudio()" src="../images/play-white.png"
                        alt="">
                    <img class="h-30px" onclick="forward()" src="../images/backward-white.png" alt="">
                </div>
                <div class="btn-group dropup col-2 center-elements">
                    <img class="h-20px" src="../images/audio-menu-white.png" alt="" type="button"
            ...
            <div class="center-elements">
                <video id="myAudio" src="../videos/rupaybachaoVid.mp4"></video>
                <div class="audio-player text-white center-elements">
                    <span id="currentTime">0:00</span>
            ...
            <div class="wave center-elements h-45px" id="wave">
                <span></span>
                <span></span>
                <span></span>
                <span></span>
